  ...
  return (
    <div className="relative inline-block shrink-0 select-none">
      <select
        ...
        className="px-4 py-2.5 rounded-[var(--radius-sm)] border border-[var(--ag-gray-200)] text-xs font-bold bg-white outline-none cursor-pointer pr-8 focus:border-[var(--ag-red)] appearance-none transition-colors"
        style={{
